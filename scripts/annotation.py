...
def combine_df(mapping_tools: list, cell_type: str, input_dir: str, library: str, threads: int) -> pd.DataFrame:
    """
    Combines DataFrames generated by different mapping tools into a single DataFrame.
    Iterates over a list of mapping tools (e.g., "bowtie", "bowtie2", "minimap2"), 
    calling the `mapping_main` function to process the input data.
